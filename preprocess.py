...
class EMGdata:
    def __init__(self, corpus_path, train_path, valid_path, test_path, train_noise_signal, valid_noise_signal, test_noise_signal, trunk_sp=False):
        self.corpus_path = corpus_path
        ...
        if trunk_sp:
            self.test_channel = [11]  # biceps brachii sEMG
        else:
            self.test_channel = [9, 10, 11, 12]  # change to channel 9 ~ 12 for testing
...
if __name__ == '__main__':
    with open('cfg/local_cfg.yaml', "r") as f:
